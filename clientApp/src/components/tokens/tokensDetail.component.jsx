...
import './tokensDetail.component.css';
        ...
        return (
            <>
                        ...
                        <div className="page-title-box">
                            <div className="btn-group float-right">
                                <ol className="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li className="breadcrumb-item"><Link to=''>Tokens</Link></li>
                                    <li className="breadcrumb-item active">Token Detail</li>
                                </ol>
                            </div>
                        ...
                        <div className="card-box">
                            ...
                            <div className="form-group row">
                                <div className="col-lg-10" style={{textAlign: "center"}}>
                                    <button type="button" class="btn btn-outline-secondary btn-rounded waves-light waves-effect"><i class="mdi mdi-arrow-down"></i></button>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-9">
                ...
                <div className="row">
                    <div className="col-lg-8">
                        <div className="card-box task-detail">
                            <div className="media mt-10">
                                <div className="media-body">
                                    <h3 className="media-heading mb-0 mt-0">Stats</h3>
                                </div>
                            </div>
                            <div class="row">
                    ...
                    <div className="col-lg-4">
                        <div className="card-box">
                            <h4 className="header-title m-b-30">Your Balances </h4>

                            <div>
                                <div class="balance"><div class="balance-display">
                                    <img class="token dXNPyx" alt="ETH logo"
                                        src="data:image/png;base64," />&nbsp;0.02 ETH
                                </div>
                                    <div class="balance-display">$37.18</div></div>
                            </div>
                        </div>
                    </div>
                </div>
...
export default TokensDetailComponent