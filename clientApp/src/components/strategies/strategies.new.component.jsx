...
export class StrategiesNewComponent extends Component {
    ...
    toggleTab = async () => {
        this.setState({
            isOnDesigner: !this.state.isOnDesigner,
            isOnTest: !this.state.isOnTest
        });
                        ...
                        <div className="page-title-box">
                            <div className="btn-group float-right">
                                <ol className="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li className="breadcrumb-item active"><Link to=''>New</Link></li>
                                </ol>
                            </div>
                            <h4 className="page-title">New strategy</h4>
                        </div>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div className="col-8">
                        <div className="card-box">
                            <div className='row'>
                                <div className='col-md-12'>
                                    <div className="button-list float-left">
                                        ...
                                        <button type="button" className="btn btn-info waves-light waves-effect" onClick={() => this.toggleTab()}>
                                            <i className="mdi mdi-play-circle-outline"></i> Test
                                        </button>
                                        <button type="button" className="btn btn-info waves-light waves-effect">
                                            <i className='mdi mdi-code-tags'></i> Code
                                        </button>
                                        <button type="button" className="btn btn-danger waves-light waves-effect">
                            ...
                            <div className="row mt-5" style={{display : this.state.isOnDesigner ? "block" : "none"}}>
                                <div className="col-12">
                            ...
                            <div className='row mt-5' id='test_tab' style={{ display: this.state.isOnTest ? "block" : "none" }}>
                               <div className='col-md-12'>
                               <div className='row'>
                                    <div className='col-md-12'>
                            ...
                            <div className="form-group row" style={{display: this.state.isOnTest ? "inline-flex" : "none"}}>
                                <div className="col-4 m-b-30">
                                    ...
                                    <p className="m-t-10">
                                        <button type="button" className="btn btn-success btn-block waves-effect waves-light">Deploy this configuration</button>
...
export default StrategiesNewComponent