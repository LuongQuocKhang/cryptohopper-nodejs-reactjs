...
export class AirdroptrackingComponent extends Component {
  render() {
    return (
        <>
        <div className="row">
                ...
                <div className="page-title-box">
                    <div className="btn-group float-right">
                        <ol className="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li className="breadcrumb-item active"><Link to=''>Airdrop</Link></li>
                        </ol>
                    </div>
                    <h4 className="page-title">Airdrop</h4>
                </div>
            </div>
        </div>
...
export default AirdroptrackingComponent