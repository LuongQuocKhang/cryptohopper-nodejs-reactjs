                    ...
                    <td>
                        <div className="sc-1bit9h6-2 sc-1bit9h6-3 fVPQDM jqxpYK">
                            <div className="sc-1bit9h6-27 llCfYU">
                                <img className="token" alt="token logo" src={signal.tokenImg} />
                                <div className="hrxmJC"></div>
                            </div>
                            <div className="sc-1bit9h6-0 sc-1bit9h6-17 hJyIyF gKCxsP">
                                <div className="sc-1bit9h6-18 kSNzln">{signal.tokenName}</div>
                                <div className="sc-1bit9h6-0 sc-1bit9h6-19 hJyIyF eRIUlN">{signal.token}</div>
                            </div>
                        </div>
                    </td>
                    <td>{signal.date}</td>
                        ...
                        <div className="page-title-box">
                            <div className="btn-group float-right">
                                <ol className="breadcrumb hide-phone p-0 m-0">
                                    ...
                                    <li className="breadcrumb-item active">Signals</li>
                                </ol>
                            </div>
                            <h4 className="page-title">Signals</h4>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-12">
                        <div className="card-box">
                            <h4 className="m-t-0 header-title"> Top signals </h4>
